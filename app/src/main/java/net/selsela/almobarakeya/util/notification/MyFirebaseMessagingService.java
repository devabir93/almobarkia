...
import net.selsela.almobarakeya.injection.component.DaggerServiceComponent;
import net.selsela.almobarakeya.injection.component.ServiceComponent;
...
//            handleNotification(remoteMessage.getNotification().getBody(), remoteMessage.getSentTime());
        ...
        if (remoteMessage.getData().size() > 0) {
            Timber.d("Data Payload: %s ", remoteMessage.getData().toString());
