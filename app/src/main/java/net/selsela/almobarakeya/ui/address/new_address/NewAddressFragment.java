...
import net.selsela.almobarakeya.ui.address.AddressMvpView;
import net.selsela.almobarakeya.ui.address.AddressPresenter;
import net.selsela.almobarakeya.ui.base.BaseFragment;
import net.selsela.almobarakeya.util.DialogFactory;
import net.selsela.almobarakeya.util.SpinnerAdapter;
...
public class NewAddressFragment extends BaseFragment implements AddressMvpView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (preferencesHelper.getCountry().getPrefix().equals(965)) {
            ...
            block.setText(getString(R.string.peicenum_label));
        }
        return view;
    ...
    public OrderBody getNewAddress() {
        ...
        if (govId < 1) {
            ...
            DialogFactory.showAlertDialog(getActivity(),getString(R.string.empty_gov));
//            ((TextView) govSpinner.getRootView()).setError(getContext().getString(R.string.emptytopic_label));
            return null;
        }

        if (areaId < 1) {
            Timber.d("region < 0");
            DialogFactory.showAlertDialog(getActivity(),getString(R.string.empty_area));
