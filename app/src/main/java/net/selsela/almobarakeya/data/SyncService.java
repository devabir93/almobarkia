...
import net.selsela.almobarakeya.util.AndroidComponentUtil;
import net.selsela.almobarakeya.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        SelselaApplication.get(this).getComponent().inject(this);
    }
