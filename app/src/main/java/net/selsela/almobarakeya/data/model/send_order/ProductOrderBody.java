...
package net.selsela.almobarakeya.data.model.send_order;
...
public class ProductOrderBody extends SugarRecord implements Parcelable, Cloneable {
    ...
    public ProductOrderBody(Integer orderId, Integer countryId, Integer quantity, Product product, String price, Size size, Color color, int isGift, String giftName, String giftMessage, int userId, int colorId, int sizeId, Double weight, Integer amount, Integer imageId, String imageUrl, String priceForSingleItem) {
